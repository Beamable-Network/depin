...
export function getUsdcMint(network: "mainnet" | "devnet") {
  return network === 'mainnet' ? address('EPjFWdd5AufqSSqeM2qN1xzybapC8G4wEGGkZwyTDt1v') : address('4zMMC9srt5Ri5X14GAgXhaHii3GnPAEERYPJgZJDncDU');
}

export function getCheckerTree(network: "mainnet" | "devnet") {
  return network === 'mainnet' ? address('3eHEnELWr4fdVEhq4QKyyjAJ9N9cc197ZNjceb84QarW') : address('BMBcEkev9ZEMdqYUjNirrsB4E8uuVfcno7haTcLnwkXo');
}
