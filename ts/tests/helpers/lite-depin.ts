import { BPF_LOADER_UPGRADEABLE_PROGRAM, DEPIN_PROGRAM, getMonthStartTimestamp, MPL_ACCOUNT_COMPRESSION_PROGRAM, MPL_BUBBLEGUM_PROGRAM, periodToTimestamp, timestampToPeriod, WORKER_STAKE_PROGRAM } from '@beamable-network/depin';
