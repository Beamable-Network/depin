...
**Every license you run will generate network rewards**, which are visible and claimable through the [Beamable Network Portal](https://nodes.beamable.network/).
...
- Licenses must be **activated and delegated** via the [Beamable Network Portal](https://nodes.beamable.network/)
...
**To activate and delegate your licenses:**
1. Visit [https://nodes.beamable.network/](https://nodes.beamable.network/)
2. Connect your wallet that owns the license(s)
3. Activate your license(s) and set the delegate wallet address
...
View and claim your checker rewards at the [Beamable Network Portal](https://nodes.beamable.network/).
...
1. Verify the license is activated in the [Beamable Network Portal](https://nodes.beamable.network/)
...
- Visit the [Beamable Network Portal](https://nodes.beamable.network/)
