...
- **Auto-instrumentation** for Pino, HTTP, and other Node.js libraries
...
Select service `@beamable/depin-checker` and click "Find Traces" to see your application traces.
...
- Pino and HTTP instrumentations are enabled
